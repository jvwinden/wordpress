...
?><div class="<?php echo ( 3 == $topbar_leftcontent )? 'socialfollow' : 'top-links'; ?> lftflot"><?php
 ...
 switch($topbar_leftcontent)
 {
	...
	case 2:
	?>
	<h6><i class="fa-envelope-o"></i> <?php echo '<a href="mailto:'.$webnus_options->webnus_header_email().'">'.$webnus_options->webnus_header_email().'</a>'; ?></h6> <h6><i class="fa-phone"></i> <?php echo $webnus_options->webnus_header_phone();?></h6>
	<?php
	break;
	case 3:
...
<div class="<?php echo ( 3 == $topbar_rightcontent )? 'socialfollow' : 'top-links'; ?> rgtflot"><?php
 switch($topbar_rightcontent)
 {
	...
	case 2:
	?>
	<h6><i class="fa-envelope-o"></i> <a href="mailto:<?php echo $webnus_options->webnus_header_email(); ?>"><?php echo $webnus_options->webnus_header_email(); ?></a></h6> <h6><i class="fa-phone-2"></i> <?php echo $webnus_options->webnus_header_phone();?></h6>
	<?php
	break;
	case 3:
		if($webnus_options->webnus_top_social_icons_facebook())
