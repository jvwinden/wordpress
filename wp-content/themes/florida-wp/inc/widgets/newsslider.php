...
class WebnusPostSliderWidget extends WP_Widget{
	...
	function __construct(){
		...
		$params = array(
		'description'=> __( "Webnus Post Slider Widget", 'WEBNUS_TEXT_DOMAIN'),
		'name'=> __( "Webnus-Post Slider", 'WEBNUS_TEXT_DOMAIN')
		);
	...
	public function form($instance){
		...
		<p>
		<label for="<?php echo $this->get_field_id('count') ?>"><?php esc_html_e('Posts Count','WEBNUS_TEXT_DOMAIN'); ?>: </label>
		<input type="text"
