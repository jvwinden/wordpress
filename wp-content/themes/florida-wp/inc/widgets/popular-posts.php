...
class Webnus_PopularPosts extends WP_Widget{
	...
	function __construct(){
		...
		$params = array(
		'description'=> __( "Display Popular Posts", 'WEBNUS_TEXT_DOMAIN'),
		'name'=> __( "Webnus-Popular Posts", 'WEBNUS_TEXT_DOMAIN')
		);
	...
	public function form($instance){
		...
		<p>
		<label for="<?php echo $this->get_field_id('numberOfPosts') ?>"><?php esc_html_e('Number of Posts','WEBNUS_TEXT_DOMAIN'); ?>:</label>
		<input
		type="text"
		class="widefat"
