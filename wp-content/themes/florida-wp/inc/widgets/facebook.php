...
class webnus_facebook_widget extends WP_Widget{
	...
	function __construct(){
		...
		$params = array(
		'description'=> __( "Facebook Box", 'WEBNUS_TEXT_DOMAIN'),
		'name'=> __( "Webnus - Facebook", 'WEBNUS_TEXT_DOMAIN'),
		);
	...
	public function form($instance){
		...
		<p>
		<label for="<?php echo $this->get_field_id('url') ?>"><?php esc_html_e('Page Address','WEBNUS_TEXT_DOMAIN'); ?>:</label>
		<input
		type="text"
		class="widefat"
