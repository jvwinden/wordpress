...
if(!class_exists('webnus_importer_class'))
{
	class webnus_importer_class{
							...
							<tr valign="middle">
								...
								<td>
									<select name="webnus_import_option" id="webnus_import_option">
										...
										<option value="perdido">Perdido Template</option>
										<option value="wekiva">Wekiva Template</option>
										<option value="manatee">Manatee Template</option>
										<option value="alafia">Alafia Template</option>
				...
				jQuery('#import_demo_data').click(function() {
					...
					switch(webnus_import_option) {
						case 'all':
							...
							break;
						case 'perdido':
							file_name = 'perdido.xml';
							break;
						case 'wekiva':
							file_name = 'wekiva.xml';
							break;
						case 'manatee':
							file_name = 'manatee.xml';
							break;
						case 'alafia':
							file_name = 'alafia.xml';
							break;
						case 'pages':
		...
		function import_menus()
		{
			...
			$menu = wp_get_nav_menu_object('mani-nav');
			if(!empty($menu))
			{
