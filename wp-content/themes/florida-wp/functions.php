...
function webnus_api() {
	// Google Map api
	GLOBAL $webnus_options;
	$api_code 		= ( $webnus_options->webnus_google_map_api() ) ? 'key=' . $webnus_options->webnus_google_map_api() : '';
	$sign_in 		= (  $webnus_options->webnus_google_map_api_sign_in() ) ? 'signed_in=true' : '';
